...
@interface SJNewFeatureViewController ()
...
- (void)setUpSubView {
    ...
    CGFloat butH = 32;
    SJSJNewFeatureBut *wwechatBut = [SJSJNewFeatureBut buttonWithType:UIButtonTypeCustom];
    ...
    // 微博
    SJSJNewFeatureBut *wweiboBut = ({
        
        SJSJNewFeatureBut *wweiboBut = [SJSJNewFeatureBut buttonWithType:UIButtonTypeCustom];
